...
class OutgoingMessage {
   ...
   * adds an remove_quick_replies param to the outgoing message
   * 
   * @return {OutgoinMessage} returns this object to allow for chaining of methods.
   */
  removeQuickReplies() {
    if(has(this,'message.quick_replies')){
      return this.__removeProperty('message.quick_replies', 'quick_replies');
    }else{
      return this.__addProperty('message.remove_quick_replies', 'remove_quick_replies', true);
    }
  }
